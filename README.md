...
手順書作成の見積について、対象26手順を改めて精査し、ESXi・AWS・GCP関連を含む全手順を対象として、1名体制で算出しました。各手順の画面数や実機確認の難易度に応じて工数を見直した結果、手順書作成が182時間、テンプレート整備・全体整合性確認・レビュー2回・納品管理などの共通作業が30時間となり、基礎工数は合計212時間、26.5人日です。PoC完了済みで既存資料を再利用できることを前提に15％のバッファを加え、提案見積は31人日、1名で約6～7週間としています。なお、権限・Credential・FW／NSG等の申請待ちや、環境再構築・障害調査は本見積には含めていません。


手順書作成の見積について、対象26手順を改めて精査し、ESXi・AWS・GCP関連を含む全手順を対象として、1名体制で算出しました。各手順の画面数や実機確認の難易度に応じて工数を見直し、各手順単位の「単体確認・修正」工数を除外した結果、手順書作成工数は146.5時間となりました。これに、テンプレート整備・全体整合性確認・レビュー2回・納品管理などの共通作業30時間を加え、基礎工数は合計176.5時間、約22.06人日です。PoC完了済みで既存資料を再利用できることを前提に15％のバッファを加え、提案見積は26人日、1名で約5～6週間としています。なお、共通作業としてのレビュー2回は見積に含めていますが、権限・Credential・FW／NSG等の申請待ちや、環境再構築・障害調査は本見積には含めていません。
